...
if __name__ == "__main__":
    ...
    if input("Run the experiment? (y/n): ") == "y":
        ...
        # Save the results.
        jnp.save("src/files/experiment_baseline/hybrid_loss.npy", loss_history_hyb)
        ...
        loss_history_hyb = jnp.load("src/files/experiment_baseline/hybrid_loss.npy")
        loss_history_fem = jnp.load("src/files/experiment_baseline/fem_loss.npy")
        loss_history_pinn = jnp.load("src/files/experiment_baseline/pinn_loss.npy")
        param_history_hyb = jnp.load("src/files/experiment_baseline/hybrid_params.npy")
        param_history_fem = jnp.load("src/files/experiment_baseline/fem_params.npy")
        param_history_pinn = jnp.load("src/files/experiment_baseline/pinn_params.npy")
