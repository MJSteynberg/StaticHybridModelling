...
if __name__ == "__main__":
    ...
    if input("Train the hybrid model? (y/n): ") == "y":
        ...
        jnp.save("src/files/experiment_4/loss_history_hyb.npy", loss_history_hyb)
        jnp.save("src/files/experiment_4/param_history_hyb.npy", param_history_hyb)
        # save the model
        _, state = nnx.split(syn_model)
        
        checkpoint_path = os.path.abspath("src/files/experiment_4/checkpoint")
    ...
    plt.savefig("src/results/experiment_4/prediction_comparison.png")
